  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "fitra.rizky@example.com",
      href: "mailto:fitra.rizky@example.com",
    },
    {
      icon: Phone,
      label: "Phone",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <form className="space-y-6">
              ...
              <motion.button
                type="submit"
                className="w-full px-6 py-3 bg-accent text-white font-medium rounded-lg hover:bg-accent-hover transition-colors duration-300"
